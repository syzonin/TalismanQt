    ...
    switch(c->getAlignment()){
        case -1:
            if(c->getLifePoints() > 1){
                txtLog->append("This holy place rejects your Evil heart, weakening your body and draining your very soul. Lose 1 Life");
                c->setLifePoints(c->getLifePoints() - 1);
            }
            else{
                txtLog->append("This holy place rejects you and your Evil heart. You cautiously avoid the Chapel and continue your journey.");
            }
            break;
        case 1:
            txtLog->append("The Chapel welcome your Pure heart, healing your body and soothing the mind. Gain up to your default Life Points");
            if(c->getLifePoints() < c->getLife())
                c->setLifePoints(c->getLife());
            break;
        default:
            txtLog->append("The Chapel sees that you come in peace and offers to heal your wounds at the cost of 1 Gold");
